...
(cl:defmethod product-val ((m <cmdPickup>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader multirob_test-msg:product-val is deprecated.  Use multirob_test-msg:product instead.")
  (product m))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<cmdPickup>)))
  ...
  "56424df38f10c6e3d91bcb64ba6d8fa9")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'cmdPickup)))
  "Returns md5sum for a message object of type 'cmdPickup"
  "56424df38f10c6e3d91bcb64ba6d8fa9")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<cmdPickup>)))
  ...
  (cl:format cl:nil "string source~%string destination~%string product~%int32 amount~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'cmdPickup)))
  "Returns full string definition for message of type 'cmdPickup"
  (cl:format cl:nil "string source~%string destination~%string product~%int32 amount~%~%~%"))
