...
class guiElements:
    def sendCommand(self, widget):
        self.cmd_pub.publish(self.comboBoxSource.get_active_text(), self.comboBoxDestination.get_active_text(), "test", int(self.amount.get_text()))
    ...
    def __init__(self):
        self.cmd_pub = rospy.Publisher("pickup_command", cmdPickup, queue_size=10)
